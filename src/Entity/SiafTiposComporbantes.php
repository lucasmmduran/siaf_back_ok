...
use App\Repository\SiafTiposComporbantesRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: SiafTiposComporbantesRepository::class)]
class SiafTiposComporbantes
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     */
    #[ORM\OneToMany(targetEntity: SiafEstadosComprobantes::class, mappedBy: 'SiafTiposComporbantes')]
    ...
    public function addSiafEstadosComprobante(SiafEstadosComprobantes $siafEstadosComprobante): static
    {
        if (!$this->siafEstadosComprobantes->contains($siafEstadosComprobante)) {
            ...
            $siafEstadosComprobante->setSiafTiposComporbantes($this);
        }
    ...
    public function removeSiafEstadosComprobante(SiafEstadosComprobantes $siafEstadosComprobante): static
    {
        if ($this->siafEstadosComprobantes->removeElement($siafEstadosComprobante)) {
            ...
            if ($siafEstadosComprobante->getSiafTiposComporbantes() === $this) {
                $siafEstadosComprobante->setSiafTiposComporbantes(null);
            }
        }
