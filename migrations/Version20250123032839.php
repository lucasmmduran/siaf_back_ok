 ...
 */
final class Version20250123032839 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pla_conf_plan_concepto (id INT AUTO_INCREMENT NOT NULL, pla_conf_planes_id INT DEFAULT NULL, plan_concepto VARCHAR(45) NOT NULL, fecha_vigencia_desde DATETIME DEFAULT NULL, fecha_vigencia_hasta DATETIME DEFAULT NULL, INDEX IDX_95BBB861341470E5 (pla_conf_planes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pla_conf_plan_objetos_gasto (id INT AUTO_INCREMENT NOT NULL, pla_conf_tipo_plan_id INT DEFAULT NULL, siaf_objetos_gasto_id INT DEFAULT NULL, fecha_vigencia_desde DATETIME DEFAULT NULL, fecha_vigencia_hasta DATETIME DEFAULT NULL, INDEX IDX_71C57A74A90D98E2 (pla_conf_tipo_plan_id), INDEX IDX_71C57A74D4BDE734 (siaf_objetos_gasto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pla_conf_plan_objetos_gasto_res (id INT AUTO_INCREMENT NOT NULL, pla_conf_tipo_planes_id INT DEFAULT NULL, siaf_objetos_gasto_id INT DEFAULT NULL, nivel_planificacion LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', lista_objetos_gasto VARCHAR(120) NOT NULL, fecha_vigencia_desde DATETIME DEFAULT NULL, fecha_vigencia_hasta DATETIME DEFAULT NULL, INDEX IDX_186D7B5ED1AE59E8 (pla_conf_tipo_planes_id), INDEX IDX_186D7B5ED4BDE734 (siaf_objetos_gasto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pla_conf_plan_unidades (id INT AUTO_INCREMENT NOT NULL, siaf_unidades_id INT DEFAULT NULL, pla_conf_tipo_planes_id INT DEFAULT NULL, fecha_vigencia_desde DATETIME DEFAULT NULL, fecha_vigencia_hasta DATETIME DEFAULT NULL, INDEX IDX_F5A8847534B4022F (siaf_unidades_id), INDEX IDX_F5A88475D1AE59E8 (pla_conf_tipo_planes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pla_conf_planes (id INT AUTO_INCREMENT NOT NULL, pla_conf_tipo_plan_id INT DEFAULT NULL, cod_tipo_plan VARCHAR(3) NOT NULL, tipo_plan VARCHAR(60) NOT NULL, fecha_vigencia_desde DATETIME NOT NULL, fecha_vigencia_hasta DATETIME NOT NULL, abr_tipo_plan VARCHAR(20) NOT NULL, descripcion VARCHAR(250) NOT NULL, nivel_tipo LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', nivel INT NOT NULL, INDEX IDX_13FA9ADCA90D98E2 (pla_conf_tipo_plan_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pla_conf_unidades_programatica (id INT AUTO_INCREMENT NOT NULL, siaf_unidades_id INT DEFAULT NULL, siaf_aperturas_programaticas_id INT DEFAULT NULL, fecha_vigencia_desde DATETIME NOT NULL, fecha_vigencia_hasta DATETIME DEFAULT NULL, INDEX IDX_5D83144E34B4022F (siaf_unidades_id), INDEX IDX_5D83144E222903D5 (siaf_aperturas_programaticas_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pla_planes_cabecera (id INT AUTO_INCREMENT NOT NULL, pla_conf_planes_id INT DEFAULT NULL, siaf_aperturas_programaticas_id INT DEFAULT NULL, siaf_ejercicios_id INT DEFAULT NULL, siaf_unidades_id INT DEFAULT NULL, fecha_ingreso DATETIME NOT NULL, fecha_ult_actualizacion DATETIME NOT NULL, nro_plan INT NOT NULL, identificacion_plan VARCHAR(20) NOT NULL, version INT NOT NULL, INDEX IDX_EF18B5CA341470E5 (pla_conf_planes_id), INDEX IDX_EF18B5CA222903D5 (siaf_aperturas_programaticas_id), INDEX IDX_EF18B5CA1655D8F4 (siaf_ejercicios_id), INDEX IDX_EF18B5CA34B4022F (siaf_unidades_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pla_planes_partidas (id INT AUTO_INCREMENT NOT NULL, pla_planes_procesos_id INT DEFAULT NULL, siaf_fuentes_financiamiento_id INT DEFAULT NULL, siaf_aperturas_programaticas_id INT DEFAULT NULL, siaf_objetos_gasto_id INT DEFAULT NULL, compromiso_mes1 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes1 NUMERIC(18, 2) NOT NULL, importe_no_programado_orig NUMERIC(18, 2) NOT NULL, importe_no_programado NUMERIC(18, 2) NOT NULL, compromiso_mes2 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes2 NUMERIC(18, 2) NOT NULL, compromiso_mes3 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes3 NUMERIC(18, 2) NOT NULL, compromiso_mes4 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes4 NUMERIC(18, 2) NOT NULL, compromiso_mes5 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes5 NUMERIC(18, 2) NOT NULL, compromiso_mes6 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes6 NUMERIC(18, 2) NOT NULL, compromiso_mes7 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes7 NUMERIC(18, 2) NOT NULL, compromiso_mes8 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes8 NUMERIC(18, 2) NOT NULL, compromiso_mes9 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes9 NUMERIC(18, 2) NOT NULL, compromiso_mes10 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes10 NUMERIC(18, 2) NOT NULL, compromiso_mes11 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes11 NUMERIC(18, 2) NOT NULL, compromiso_mes12 NUMERIC(18, 2) NOT NULL, compromiso_orig_mes12 NUMERIC(18, 2) NOT NULL, devengado_mes1 NUMERIC(18, 2) NOT NULL, devengado_orig_mes1 NUMERIC(18, 2) NOT NULL, devengado_mes2 NUMERIC(18, 2) NOT NULL, devengado_orig_mes2 NUMERIC(18, 2) NOT NULL, devengado_mes3 NUMERIC(18, 2) NOT NULL, devengado_orig_mes3 NUMERIC(18, 2) NOT NULL, devengado_mes4 NUMERIC(18, 2) NOT NULL, devengado_orig_mes4 NUMERIC(18, 2) NOT NULL, devengado_mes5 NUMERIC(18, 2) NOT NULL, devengado_orig_mes5 NUMERIC(18, 2) NOT NULL, devengado_mes6 NUMERIC(18, 2) NOT NULL, devengado_orig_mes6 NUMERIC(18, 2) NOT NULL, devengado_mes7 NUMERIC(18, 2) NOT NULL, devengado_orig_me7 NUMERIC(18, 2) NOT NULL, devengado_mes8 NUMERIC(18, 2) NOT NULL, devengado_orig_me8 NUMERIC(18, 2) NOT NULL, devengado_mes9 NUMERIC(18, 2) NOT NULL, devengado_orig_me9 NUMERIC(18, 2) NOT NULL, devengado_mes10 NUMERIC(18, 2) NOT NULL, devengado_orig_me10 NUMERIC(18, 2) NOT NULL, devengado_mes11 NUMERIC(18, 2) NOT NULL, devengado_orig_me11 NUMERIC(18, 2) NOT NULL, devengado_mes12 NUMERIC(18, 2) NOT NULL, devengado_orig_me12 NUMERIC(18, 2) NOT NULL, sub_clase INT DEFAULT NULL, INDEX IDX_BF53852268357A88 (pla_planes_procesos_id), INDEX IDX_BF53852249AA8D2D (siaf_fuentes_financiamiento_id), INDEX IDX_BF538522222903D5 (siaf_aperturas_programaticas_id), INDEX IDX_BF538522D4BDE734 (siaf_objetos_gasto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pla_planes_procesos (id INT AUTO_INCREMENT NOT NULL, pla_planes_cabecera_id INT DEFAULT NULL, pla_conf_tipo_planes_id INT DEFAULT NULL, siaf_moneda_id INT DEFAULT NULL, nro_linea INT NOT NULL, descripcion VARCHAR(180) NOT NULL, nombre VARCHAR(60) NOT NULL, identificacion VARCHAR(45) DEFAULT NULL, es_plurianual TINYINT(1) NOT NULL, es_moneda_extranjera TINYINT(1) NOT NULL, esta_presupuestado TINYINT(1) DEFAULT NULL, tipo_tasa LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', tasa_conversion NUMERIC(18, 6) DEFAULT NULL, importe_total NUMERIC(18, 2) NOT NULL, importe_total_orig NUMERIC(18, 2) NOT NULL, importe_ejercicio NUMERIC(18, 2) NOT NULL, importe_ejercicio_orig NUMERIC(18, 2) NOT NULL, importe_anterior_orig NUMERIC(18, 2) NOT NULL, importe_proximo_ejercicio_orig NUMERIC(18, 2) NOT NULL, expediente_impulso VARCHAR(45) NOT NULL, tipo_registro LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', referencia_linea_proceso VARCHAR(45) NOT NULL, INDEX IDX_49D17E6570A714E2 (pla_planes_cabecera_id), INDEX IDX_49D17E65D1AE59E8 (pla_conf_tipo_planes_id), INDEX IDX_49D17E65DC25BE4A (siaf_moneda_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE siaf_aperturas_programaticas (id INT AUTO_INCREMENT NOT NULL, siaf_finalidad_funcion_id INT DEFAULT NULL, siaf_servicios_id INT DEFAULT NULL, siaf_ejercicios_id INT DEFAULT NULL, siaf_categorias_programaticas_id INT DEFAULT NULL, cod_apertura_programatica VARCHAR(14) NOT NULL, INDEX IDX_BB027480C8EBA48 (siaf_finalidad_funcion_id), INDEX IDX_BB027480196099F1 (siaf_servicios_id), INDEX IDX_BB0274801655D8F4 (siaf_ejercicios_id), INDEX IDX_BB02748014FE202F (siaf_categorias_programaticas_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE siaf_estados_comprobantes (id INT AUTO_INCREMENT NOT NULL, siaf_tipos_comporbantes_id INT DEFAULT NULL, estado VARCHAR(45) NOT NULL, desc_estado VARCHAR(180) NOT NULL, INDEX IDX_92E70DB6865E68BF (siaf_tipos_comporbantes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE siaf_finalidad_funcion (id INT AUTO_INCREMENT NOT NULL, siaf_ejercicios_id INT DEFAULT NULL, id_padre_id INT DEFAULT NULL, cod_finalidad_funcion VARCHAR(3) NOT NULL, funcional VARCHAR(80) DEFAULT NULL, nivel INT NOT NULL, INDEX IDX_3202B6281655D8F4 (siaf_ejercicios_id), INDEX IDX_3202B62831E700CD (id_padre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE siaf_fuentes_financiamiento (id INT AUTO_INCREMENT NOT NULL, siaf_ejercicios_id INT DEFAULT NULL, id_padre_id INT DEFAULT NULL, cod_fuente_financiamiento VARCHAR(2) NOT NULL, fuente_financiamiento VARCHAR(180) NOT NULL, nivel INT NOT NULL, INDEX IDX_BE2BFF1B1655D8F4 (siaf_ejercicios_id), INDEX IDX_BE2BFF1B31E700CD (id_padre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE siaf_instituciones (id INT AUTO_INCREMENT NOT NULL, siaf_ejercicios_id INT DEFAULT NULL, id_padre_id INT DEFAULT NULL, cod_institucion VARCHAR(9) NOT NULL, institucion VARCHAR(180) NOT NULL, nivel INT NOT NULL, INDEX IDX_8CF158A21655D8F4 (siaf_ejercicios_id), INDEX IDX_8CF158A231E700CD (id_padre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE siaf_objetos_gasto (id INT AUTO_INCREMENT NOT NULL, siaf_ejercicios_id INT DEFAULT NULL, id_padre_id INT DEFAULT NULL, siaf_objetos_gasto VARCHAR(9) NOT NULL, abr_objeto_gasto VARCHAR(45) DEFAULT NULL, nivel INT NOT NULL, tipo LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_543626FF1655D8F4 (siaf_ejercicios_id), INDEX IDX_543626FF31E700CD (id_padre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE siaf_organigrama (id INT AUTO_INCREMENT NOT NULL, id_padre_id INT DEFAULT NULL, cod_unidad_organizacional VARCHAR(10) NOT NULL, unidad_organizacional VARCHAR(45) NOT NULL, abr_unidad_organizacional VARCHAR(15) NOT NULL, fecha_vigencia_desde DATETIME NOT NULL, fecha_vigencia_hasta DATETIME DEFAULT NULL, INDEX IDX_770484D331E700CD (id_padre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE siaf_servicios (id INT AUTO_INCREMENT NOT NULL, siaf_ejercicios_id INT DEFAULT NULL, cod_servicio VARCHAR(10) NOT NULL, servicio VARCHAR(45) DEFAULT NULL, abr_servicio VARCHAR(15) NOT NULL, INDEX IDX_AB2D0AB71655D8F4 (siaf_ejercicios_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE siaf_tipos_comporbantes (id INT AUTO_INCREMENT NOT NULL, cod_tipo_comprobantes VARCHAR(5) NOT NULL, tipo_comporbante VARCHAR(45) NOT NULL, desc_tipo_comprobante VARCHAR(180) NOT NULL, fecha_vigencia_desde DATETIME NOT NULL, fecha_vigencia_hasta DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE siaf_unidades (id INT AUTO_INCREMENT NOT NULL, siaf_organigrama_id INT DEFAULT NULL, siaf_servicios_id INT DEFAULT NULL, id_padre_id INT DEFAULT NULL, cod_unidad VARCHAR(10) NOT NULL, unidad VARCHAR(45) NOT NULL, abr_unidad VARCHAR(15) NOT NULL, fecha_vigencia_desde DATETIME NOT NULL, fecha_vigencia_hasta DATETIME DEFAULT NULL, INDEX IDX_3C4BD894B10CD778 (siaf_organigrama_id), INDEX IDX_3C4BD894196099F1 (siaf_servicios_id), INDEX IDX_3C4BD89431E700CD (id_padre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE pla_conf_plan_concepto ADD CONSTRAINT FK_95BBB861341470E5 FOREIGN KEY (pla_conf_planes_id) REFERENCES pla_conf_planes (id)');
        ...
        $this->addSql('ALTER TABLE siaf_estados_comprobantes ADD CONSTRAINT FK_92E70DB6865E68BF FOREIGN KEY (siaf_tipos_comporbantes_id) REFERENCES siaf_tipos_comporbantes (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pla_conf_plan_concepto DROP FOREIGN KEY FK_95BBB861341470E5');
        ...
        $this->addSql('ALTER TABLE siaf_estados_comprobantes DROP FOREIGN KEY FK_92E70DB6865E68BF');
        ...
        $this->addSql('DROP TABLE pla_conf_plan_concepto');
        ...
        $this->addSql('DROP TABLE siaf_tipos_comporbantes');
